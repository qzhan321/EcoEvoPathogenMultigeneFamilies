...
N_LOCI= 2
N_ALLELES_INITIAL=N_LOCI*[{N_ALLELES_INITIAL}]

#var groups settings
GROUPS_DO_NOT_SHARE_ALLELE = True
GROUP_GENE_RATIOS = [0.2,0.8] 
FIX_GENE_RATIO = True
TRADE_OFF_S = 0
CONTINUOUS_FUNCTION=False
FUNCTION_CATEGORY = [1,0.5]
...
MAX_HOST_LIFETIME=100.0 * T_YEAR
N_POPULATIONS=1
N_HOSTS=[10000]
...
COINFECTION_REDUCES_TRANSMISSION=False
BITING_RATE_RELATIVE_AMPLITUDE=[{BITING_RATE_RELATIVE_AMPLITUDE}]
BITING_RATE_PEAK_PHASE=[0.5]
DAILY_BITING_RATE_DISTRIBUTION=[]
IRS_ON=False
IRS_START_TIMES=[100*T_YEAR]
BITING_RATE_FACTORS=[[0.3]]
IRS_IMMIGRATION_RATE_FACTORS=[1]
RATE_FACTOR_SCALE = 100*T_YEAR
MDA_ON=False
